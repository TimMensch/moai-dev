...
protected:
    ...
    /// Width of the graphical portion of the tile (cell width minus gutter).
	float		mTileWidth;
    /// Height of the graphical portion of the tile (cell height minus gutter).
	float		mTileHeight;
...
public:
	...
	static const u32 STAGGERY_FLAG	= 0x40000000;
	static const u32 STAGGER_MASK	= 0xC0000000;
	static const u32 SHAPE_MASK		= 0x3FFFFFFF;
